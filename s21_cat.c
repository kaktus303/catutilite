...
int main(int argc, char *argv[])
{
    ...
    for (int i = 1; i < argc; ++i)
    {
        if (argv[i][0] == '-')
        {
            if(strcmp(argv[i], "-b") == 0 && b_flag == 0) b_flag = 1;
            else if(strcmp(argv[i], "-e") == 0 && e_flag == 0) e_flag = 1;
            else if(strcmp(argv[i], "-n") == 0 && n_flag == 0) n_flag = 1;
            else if(strcmp(argv[i], "-s") == 0 && s_flag == 0) s_flag = 1;
            else if(strcmp(argv[i], "-t") == 0 && t_flag == 0) t_flag = 1;
            else
            {
